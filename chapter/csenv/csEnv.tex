...
为了提高软件快发效率， 微软公司在2000年之后推出了.Net Framwork， 在新版 Windows 中也越来越多的进行了预安装， 
.Net Framwork 也逐渐进化到 .NET 10+, 具备了跨平台等多项功能， 应用场景非常广泛。
...
JetBrains Rider 是另一款非常优秀的 .NET IDE，号称为 The world's most loved .NET and game dev IDE，其开发环境与PyCharm(Python开发)、Android Studio等本质上是一样的，
使用习惯也高度类似，还可以跨平台使用，非常值得尝试。


Microsoft Visual Code 是微软开源的文本编辑软件，功能比 Windows操作系统自带的记事本功能强大的多，在程序编写中可以快速查看与修改源代码。
...
我们用 \cs 语言编写经典的C语言入门程序 Hello World 。打开 Visual Code，
...
点击开始菜单中的 Developer Command Prompt for VS 或 Developer PowerShell for VS，
...
使用 Visual Studio 2022/2026 生成以上项目时，如果不勾选``不使用顶级语句''，
...
改变如某些C语言入门教材中将代码直接写入main函数中的习惯；
