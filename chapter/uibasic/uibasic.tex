...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=1]{chapter/uibasic/wpf.png}
    \caption{WPF主要组件}
    \label{fig:wpf}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=1]{chapter/uibasic/wpfsln.png}
    \caption{WPF项目结构}
    \label{fig:wpfsln}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{chapter/uibasic/AzimuthApp1.png}
    \caption{新建项目示意图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{chapter/uibasic/AzimuthApp2.png}
    \caption{方位角计算项目示意图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{chapter/uibasic/AzimuthApp3.png}
    \caption{新建类库项目示意图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{chapter/uibasic/AzimuthApp6.png}
    \caption{添加单元测试项目示意图}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.7]{chapter/uibasic/AzimuthApp7.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.8]{chapter/uibasic/AzimuthApp4.png}
\caption{引用类库项目示意图}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.7]{chapter/uibasic/AzimuthApp5.png}
\caption{选择引用类库项目示意图}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=1]{chapter/uibasic/AzimuthUI1.png}
\caption{坐标方位角计算设计界面}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=1]{chapter/uibasic/AzimuthUI2.png}
    \caption{坐标方位角计算运行界面}
