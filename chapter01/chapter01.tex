...
\lstinputlisting[language=C, firstline=33, lastline=40]{./chapter01/Ch01Ex03/Ch01Ex03/Circle.cs}

同样道理，也应对Circle进行封装，将其各个字段定义为private，
并用属性方法将其向外简单的暴露接口，相应的C\#代码为：

\lstinputlisting[language=C, firstline=51, lastline=66]{./chapter01/Ch01Ex03/Ch01Ex03/Circle.cs}
...
\lstinputlisting[language=C, firstline=67, lastline=71]{./chapter01/Ch01Ex03/Ch01Ex03/Circle.cs}
...
\lstinputlisting[language=C, firstline=75, lastline=82]{./chapter01/Ch01Ex03/Ch01Ex03/Circle.cs}

不要忘记在半径r的值发生改变后重新计算圆的面积和周长。
