...
public class GeoPoint : NotificationObject
{
    ...
    {
        return string.Format("{0},{1:#0.####},{2:#0.####},{3:#0.###},{4:#0.###}", Name, B, L, X, Y);
    }
}
\end{lstlisting}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{gaussProj/UI03.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{gaussProj/UI04.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{gaussProj/UI05.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{gaussProj/UI06.png}
